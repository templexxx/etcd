...
import (
	...
	"github.com/templexxx/etcd/etcdserver/api/snap/snappb"
	pioutil "github.com/templexxx/etcd/pkg/ioutil"
...
var (
	plog = capnslog.NewPackageLogger("github.com/templexxx/etcd", "snap")
