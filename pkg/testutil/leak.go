...
running(leaking) after all tests.
	...
	import "github.com/templexxx/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/templexxx/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/templexxx/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
			strings.Contains(stack, "github.com/templexxx/zap/zapcore.Buffer.func1") ||
			strings.Contains(stack, "github.com/templexxx/zap/zapcore.cleanOldFile") ||
